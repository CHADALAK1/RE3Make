...
ARE3MakeCharacter::ARE3MakeCharacter()
{
...
void ARE3MakeCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindTouch(IE_Pressed, this, &ARE3MakeCharacter::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &ARE3MakeCharacter::TouchStopped);
}


void ARE3MakeCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void ARE3MakeCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
	if (FingerIndex == ETouchIndex::Touch1)
	{
		StopJumping();
